...
class MainApp(MDApp):
    ...
    def build(self):
        ...
        {'name': 't_part', 'description': 'Tempo de partida do motor', 'address': 798, 'type': 'holding','mult':1},
        {'name': 'freq_des', 'description':'Frequência de operação desejada para o motor (prop. à rotação)', 'address': 799, 'type': 'holding','mult':1},
        {'name': 'freq_mot', 'description':'Frequência do motor medida', 'address': 800, 'type': 'input','mult':1},
        ...
        {'name': 'pot_entrada', 'description': 'Potência ativa de entrada do inversor', 'address': 804, 'type': 'input','mult':1},
        {'name': 'corrente', 'description': 'Corrente de entrada do inversor (RMS)', 'address': 805, 'type': 'input','mult':1},
        {'name': 'temp_estator', 'description': 'Temperatura do estator do motor', 'address': 806, 'type': 'input','mult':1},
        {'name': 'vel_esteira', 'description': 'Velocidade linear da esteira', 'address': 807, 'type': 'input','mult':1},
        {'name': 'carga', 'description': 'Peso normalizado do objeto gerado', 'address': 808, 'type': 'input','mult':1},
